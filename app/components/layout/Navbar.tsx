        ...
        <nav className="bg-gray-800">
            ...
            <div className="md:hidden" id="mobile-menu">
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    {user && (
                        <Link href="/chat" className={`text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium bg-gray-900 text-white`}>
                            Chat
                        </Link>
                    )}
                    {user ? (
                        ...
                        <Link href="/auth/signin" className={`text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium bg-gray-900 text-white`}>
                            Sign In
                        </Link>
                    )}
                </div>
